...
import com.machao.base.ffmpeg.imp.VideoM3u8FFmpegHandler;
import com.machao.base.handler.video.VideoHandler;

public class FFmpegVideoStreamHandler implements VideoHandler {
	private static final Logger logger = LoggerFactory.getLogger(FFmpegVideoStreamHandler.class);
	
	private VideoM3u8FFmpegHandler m3u8FFmpegHandler = new VideoM3u8FFmpegHandler();
